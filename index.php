...
<!-- Header Top END ==== -->
<?php require_once __DIR__ . '/public/front_include/navbar.php'; ?>
<!-- Content -->
<div class="page-content bg-white">
    ...
    <div class="rev-slider">
        <div id="rev_slider_486_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="news-gallery36" data-source="gallery" style="margin:0px auto;background-color:#ffffff;padding:0px;margin-top:0px;margin-bottom:0px;">
            ...
            <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
                <ul>
                    <!-- SLIDE  -->
                    <li data-index="rs-100" data-transition="parallaxvertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="error-404.php" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="A STUDY ON HAPPINESS" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="Science says that Women are generally happier">
                        <!-- MAIN IMAGE -->
                        <img src="/public/admin/assets/images/slider/slide1.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina />
                    ...
                    <li data-index="rs-200" data-transition="parallaxvertical" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="/public/admin/assets/images/slider/slide1.jpg" data-rotate="0" data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off" data-title="A STUDY ON HAPPINESS" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="Science says that Women are generally happier">
                        <!-- MAIN IMAGE -->
                        <img src="/public/admin/assets/images/slider/slide2.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina />
    ...
    <div class="content-block">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="courses-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                        <?php $pop = "SELECT * FROM (SELECT * FROM posts ORDER BY RAND() LIMIT 4) T1 ORDER BY created_at DESC"; ?>
                            ...
                            <?php foreach ($results as $result) : ?>
                                <div class="item">
                                    <div class="cours-bx">
                                        ...
                                        <?php else:?>
                                            <img src="/public/post_images/<?php echo $result['post_image'];?>" style="height: 150px;">
                                        <?php endif; ?>
                                            <a href="/public/front_include/pages/courses-details.php?read=<?php echo $hash->hash($result['id'], 10); ?>" class="btn">Read More</a>
                                        </div>
                                        <div class="info-bx text-center">
                                            <h5><a href="javascript:void(0);"><?php echo $result['title']; ?></a></h5>
        ...
        <!-- Form -->
        <div class="section-area section-sp1 ovpr-dark bg-fix online-cours" style="background-image:url('/public/admin/assets/images/slider/slide3.jpg');">
            <div class="container">
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-sm-6">
                            <div class="cours-search-bx m-b30">
                                ...
                                <span class="cours-search-text">Over 5 million post_crud</span>
                            </div>
                        </div>
                        <div class="col-md-4 col-sm-6">
                            <div class="cours-search-bx m-b30">
                ...
                <div class="row">
                    <div class="upcoming-event-carousel owl-carousel owl-btn-center-lr owl-btn-1 col-12 p-lr0  m-b30">
                        <div class="item">
                            <div class="event-bx">
                                <div class="action-box">
                                    <img src="/public/admin/assets/images/event/pic4.jpg" alt="">
                                </div>
                        ...
                        <div class="item">
                            <div class="event-bx">
                                <div class="action-box">
                                    <img src="/public/admin/assets/images/event/pic3.jpg" alt="">
                                </div>
                                <div class="info-bx d-flex">
                                    <div>
                                        <div class="event-time">
                        ...
                        <div class="item">
                            <div class="event-bx">
                                <div class="action-box">
                                    <img src="/public/admin/assets/images/event/pic2.jpg" alt="">
                                </div>
                                <div class="info-bx d-flex">
                                    <div>
                                        <div class="event-time">
        ...
        <!-- Testimonials -->
        <div class="section-area section-sp2 bg-fix ovbl-dark" style="background-image:url(/public/admin/assets/images/slider/slide4.jpg);">
            <div class="container">
                <div class="row">
                ...
                <div class="testimonial-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                    ...
                    <div class="item">
                        <div class="testimonial-bx">
                            <div class="testimonial-thumb">
                                <img src="/public/admin/assets/images/testimonials/pic2.jpg" alt="">
                            </div>
                            <div class="testimonial-info">
                                <h5 class="name">Peter Packer</h5>
                                <p>-Art Director</p>
                ...
                <div class="recent-news-carousel owl-carousel owl-btn-1 col-12 p-lr0">
                    <div class="item">
                        <div class="recent-news">
                            <div class="action-box">
                                <img src="/public/admin/assets/images/blog/latest-blog/pic1.jpg" alt="">
                            </div>
                            <div class="info-bx">
                                <ul class="media-post">
                    ...
                    <div class="item">
                        <div class="recent-news">
                            <div class="action-box">
                                <img src="/public/admin/assets/images/blog/latest-blog/pic2.jpg" alt="">
                            </div>
                            <div class="info-bx">
                                <ul class="media-post">
                    ...
                    <div class="item">
                        <div class="recent-news">
                            <div class="action-box">
                                <img src="/public/admin/assets/images/blog/latest-blog/pic3.jpg" alt="">
                            </div>
                            <div class="info-bx">
                                <ul class="media-post">
...
<!-- Content END-->
<?php require_once __DIR__ . '/public/front_include/footer.php'; ?>